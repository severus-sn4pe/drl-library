...
class YahooFinanceProcessor:
    ...
    def clean_data(self, data) -> pd.DataFrame:
        ...
        for tic in tic_list:
            ...
            tmp_df = pd.DataFrame(columns=["open", "high", "low", "close", "adjcp", "volume"], index=times)
    ...
    def calculate_turbulence(self, data, time_period=252):
        ...
        turbulence_index = pd.DataFrame({"time": df_price_pivot.index, "turbulence": turbulence_index})
