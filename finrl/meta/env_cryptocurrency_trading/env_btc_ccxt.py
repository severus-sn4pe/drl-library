...
class BitcoinEnv:  # custom env
    def __init__(self, data_cwd=None, price_ary=None, tech_ary=None, time_frequency=15,
                 start=None, mid1=172197, mid2=216837, end=None,
                 initial_account=1e6, max_stock=1e2, transaction_fee_percent=1e-3, mode="train", gamma=0.99):
        self.stock_dim = 1
