...
# bug fix: set Monday right, start date set 2014-01-01 ValueError: all the input array dimensions for the concatenation
# axis must match exactly, but along dimension 0, the array at index 0 has size 1658 and the array at index 1
# has size 1657
TRAIN_END_DATE = "2020-08-01"

TEST_START_DATE = "2020-08-01"
TEST_END_DATE = "2021-11-01"
