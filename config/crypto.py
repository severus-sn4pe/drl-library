...
ENSEMBLE_TRAIN_START = "11.05.2021"
ENSEMBLE_VAL_START = "25.05.2022"
ENSEMBLE_TEST_START = "22.06.2022"

ENSEMBLE_VALIDATION_WINDOW = 28
ENSEMBLE_TRAIN_WINDOW = 379
ENSEMBLE_ITERATIONS = 6
...
MODEL_PARAMS = {
    ...
    "TD3": {
        "default": {"batch_size": 32, "buffer_size": 50_000, "learning_rate": 0.001, "tau": 0.005, "device": "cuda"},
        "V201": {"batch_size": 32, "buffer_size": 50_000, "learning_rate": 0.001, "tau": 0.005, "device": "cuda"},
        "V202": {"batch_size": 128, "buffer_size": 50_000, "learning_rate": 0.001, "tau": 0.005, "device": "cuda"},
        "V203": {"batch_size": 1024, "buffer_size": 50_000, "learning_rate": 0.001, "tau": 0.005, "device": "cuda"},
        "V204": {"batch_size": 32, "buffer_size": 50_000, "learning_rate": 0.001, "tau": 0.05, "device": "cuda"},
        "V205": {"batch_size": 128, "buffer_size": 50_000, "learning_rate": 0.001, "tau": 0.05, "device": "cuda"},
        "V206": {"batch_size": 1024, "buffer_size": 50_000, "learning_rate": 0.001, "tau": 0.05, "device": "cuda"},
        "V207": {"batch_size": 32, "buffer_size": 50_000, "learning_rate": 0.01, "tau": 0.005, "device": "cuda"},
        "V208": {"batch_size": 128, "buffer_size": 50_000, "learning_rate": 0.01, "tau": 0.005, "device": "cuda"},
        "V209": {"batch_size": 1024, "buffer_size": 50_000, "learning_rate": 0.01, "tau": 0.005, "device": "cuda"},
